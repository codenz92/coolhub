  ...
  return (
    <div className="min-h-dvh bg-zinc-300 dark:bg-black flex items-center justify-center p-0 sm:p-4 transition-colors">
      <div className="w-full max-w-[600px] h-dvh sm:h-[650px] bg-white dark:bg-zinc-900 sm:rounded-3xl shadow-2xl flex flex-col border-none sm:border border-zinc-400 dark:border-zinc-800 overflow-hidden">
        ...
        {/* HEADER */}
        <div className="w-full px-4 sm:px-6 py-4 border-b dark:border-zinc-800 bg-white dark:bg-zinc-900 flex justify-between items-center">
          <div className="flex flex-col">
            <h1 className="font-black text-[10px] tracking-[0.2em] text-black dark:text-white uppercase">COOLCHAT</h1>
            <div className="flex items-center gap-2 mt-1">
              <p className="text-[7px] font-black text-zinc-400 dark:text-zinc-500 uppercase tracking-widest truncate max-w-[80px]">
                KEY: {showKey ? chatPassword : '•'.repeat(8)}
              </p>
              <button onClick={() => setShowKey(!showKey)} className="p-1 hover:opacity-70">
                {showKey ?
                  ...
                  :
                  <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" className="text-zinc-400"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>
                }
              </button>
            </div>
          </div>
