...
export default function CoolChat() {
  ...
  const [showKey, setShowKey] = useState(false); // New state for key visibility
      ...
      >
        <div className="w-full px-6 py-5 border-b dark:border-zinc-800 bg-white dark:bg-zinc-900 grid grid-cols-3 items-center min-h-[90px]">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            {/* CENSORED KEY DISPLAY WITH TOGGLE */}
            <div className="flex items-center gap-2 mt-1">
              <p className="text-[7px] font-black text-zinc-400 dark:text-zinc-500 uppercase tracking-widest truncate max-w-[120px]">
                KEY: {showKey ? chatPassword : '•'.repeat(12)}
              </p>
              <button
              ...
              >
                {showKey ? (
                  <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" className="text-zinc-400">
            ...
            <p className="text-[7px] font-black text-zinc-300 dark:text-zinc-600 uppercase tracking-widest mt-0.5">
              24H AUTO-ERASE
            </p>
          </div>
        ...
        {/* REFINED INPUT AREA WITHOUT SHADOW OVERLAP */}
